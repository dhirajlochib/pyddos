...
title = '''
  _____  _    _ _____ _____                _   _      ____   _____ _    _ _____ ____  
 |  __ \| |  | |_   _|  __ \     /\       | | | |    / __ \ / ____| |  | |_   _|  _ \ 
 | |  | | |__| | | | | |__) |   /  \      | | | |   | |  | | |    | |__| | | | | |_) |
 | |  | |  __  | | | |  _  /   / /\ \ _   | | | |   | |  | | |    |  __  | | | |  _ < 
 | |__| | |  | |_| |_| | \ \  / ____ \ |__| | | |___| |__| | |____| |  | |_| |_| |_) |
 |_____/|_|  |_|_____|_|  \_\/_/    \_\____/  |______\____/ \_____|_|  |_|_____|____/ 

 
 Author: Dhiraj Lochib                                                
 Github: http://github.com/dhirajlochib/pyddos
'''
